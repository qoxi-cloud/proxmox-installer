...
```bash
bash <(curl -sSL https://qoxi-cloud.github.io/proxmox-installer/pve-install.sh)
```
...
If you encounter issues, please [open an issue](https://github.com/qoxi-cloud/proxmox-installer/issues) on GitHub.
